const DAYZ_MAP_ID = document.body?.dataset?.mapId || 'default';
const DAYZ_MAP_DATA_KEY = `dayzMapData_${DAYZ_MAP_ID}`;
const DAYZ_MAP_PROFILES_KEY = `dayzMapProfiles_${DAYZ_MAP_ID}`;
/**
...
class UserProfilesManager {
    constructor(dayzMapInstance) {
        ...
        this.storageKey = DAYZ_MAP_PROFILES_KEY;
        this.init();
    }
    ...
    migrateOldDataIfNeeded() {
        const oldData = localStorage.getItem(DAYZ_MAP_DATA_KEY);
